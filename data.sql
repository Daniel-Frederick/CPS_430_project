...
-- LOCATION
-- ======================
INSERT INTO LOCATION (locationID, buildingName, roomNumber) VALUES
...
-- DEPARTMENT
-- ======================
INSERT INTO DEPARTMENT (departmentId, majorId, deptName, locationID) VALUES
...
-- FACULTY
-- ======================
INSERT INTO FACULTY (facultyId, email, fname, lname, departmentId, chair) VALUES
...
-- COURSE
-- ======================
INSERT INTO COURSE (courseId, departmentId, sectionNum, credits, courseName, facultyId) VALUES
...
-- SECTION
-- ======================
INSERT INTO SECTION (sectionNum, courseId, locationID, timeSlot, semester) VALUES
...
-- STUDENT
-- ======================
INSERT INTO STUDENT (fname, lname, email, grade, dob, enrollment_date, address, studentId, majorID) VALUES
...
-- ENROLLED_IN
-- ======================
INSERT INTO ENROLLED_IN (studentId, enrollmentId, sectionNum, grade) VALUES
('S001', 'E001', 1, 'A'),
('S002', 'E002', 2, 'B+'),
('S003', 'E003', 3, 'A-'),
('S004', 'E004', 4, 'B'),
